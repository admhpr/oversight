...
export { default as PostPagination } from '../../components/PostPagination.vue'
...
export const LazyPostPagination = import('../../components/PostPagination.vue' /* webpackChunkName: "components/PostPagination" */).then(c => c.default || c)
